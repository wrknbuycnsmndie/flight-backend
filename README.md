...
- [x] Реализован список рейсов с пагинацией по 10 записей.
- [x] Реализовано получение полной информации о рейсе.
- [x] Реализовано создание рейса.
- [x] Реализовано редактирование рейса.
- [x] Реализовано удаление рейса.
- [x] Реализовано получение пассажиров рейса.
- [x] Реализовано добавление пассажира.
- [x] Реализовано удаление пассажира.
- [x] Реализован справочник аэропортов.
- [x] Реализован справочник самолётов.
- [x] Все обязательные поля валидируются.
- [x] Проверяется порядок времени вылета и прилёта.
- [x] PostgreSQL запускается в Docker.
- [x] Flyway автоматически создаёт схему.
- [x] Flyway автоматически добавляет тестовые данные.
- [x] Подключение к БД выполняется через переменные окружения.
- [x] Для API используются DTO.
- [x] Ошибки возвращаются в едином формате.
- [x] Backend собирается через multi-stage Dockerfile.
- [x] Docker-образ поддерживает `linux/amd64`.
- [x] Docker-образ опубликован в Docker Hub.
- [x] Backend запускается в составе общего `docker-compose.yml`.
